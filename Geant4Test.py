# Based off of https://github.com/HaarigerHarald/geant4_pybind/tree/main
...
# else:
    # interactive mode
# UImanager.ApplyCommand("/control/execute C:\\Users\\ahorv\\PycharmProjects\\SMADLAB_NEW\\init_vis.mac")
UImanager.ApplyCommand("/control/execute C:\\Users\\ahorv\\PycharmProjects\\SMADLAB_NEW\\vis.mac")
UImanager.ApplyCommand("/control/execute C:\\Users\\ahorv\\PycharmProjects\\SMADLAB_NEW\\run1.mac")
if ui.IsGUI():
    UImanager.ApplyCommand("/control/execute C:\\Users\\ahorv\\PycharmProjects\\SMADLAB_NEW\\gui.mac")
ui.SessionStart()